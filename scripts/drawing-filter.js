canvasSettings.filterImage = function(filterRequested){

    var currentImage = new Image();
    currentImage.src = document.getElementById("canvas-real").toDataURL();
...
//button click
$('body').on('click','.grayScaleFilter',function(){
    canvasSettings.filterImage('grayScale');
})
$('body').on('click','.brightenFilter',function(){
    canvasSettings.filterImage('brighten');
})
$('body').on('click','.sharpenFilter',function(){
    canvasSettings.filterImage('sharpen');
})
